            ...
            rx.center(
                rx.vstack(
                    rx.text(
                        ...
                        rx.span("Zelfbehandeling", color="#696287"),
                        rx.span("]", color="#DACEEE"),
                        rx.span("[", color="#DACEEE"),
                        rx.span("Interactief advies", color="#696287"),
                        rx.span("]", color="#DACEEE"),
                        rx.span("[", color="#DACEEE"),
                        rx.span("Triggerpoint Community", color="#696287"),
                        rx.span("]", color="#DACEEE"),
                        font_family=styles.MONO,
                        mb=2,
                    ),
                    rx.text(
                        "Behandel triggerpoints vandaag nog.",
                        font_family=styles.MONO,
                        font_style="normal",
                        font_weight="600",
                        font_size="6xl",
                    ...
                    rx.text(
                        "Start vandaag nog met pijntherapie en maak komaf met triggerpoints.",
                        color="#342E5C",
                        font_size="1.1em",
